...
\begin{frame}[label={sec:orgb19d5e4},fragile]{So sieht F\# aus}
 \begin{minted}[bgcolor=mintedbg,frame=none,framesep=0pt,mathescape=true,fontsize=\footnotesize,tabsize=2,gobble=0]{fsharp}
...
\begin{frame}[label={sec:org338e91e},fragile]{Lösungen 1}
 \scriptsize
\begin{minted}[bgcolor=mintedbg,frame=none,framesep=0pt,mathescape=true,fontsize=\footnotesize,tabsize=2,gobble=0]{shell}
dotnet --version
\end{minted}
...
\begin{frame}[label={sec:org87b8e8a}]{Übung 2}
\begin{itemize}
...
\begin{frame}[label={sec:orge422157},fragile]{Lösung 2}
 \begin{minted}[bgcolor=mintedbg,frame=none,framesep=0pt,mathescape=true,fontsize=\footnotesize,tabsize=2,gobble=0]{shell}
...
\begin{frame}[label={sec:orgc9e4e83},fragile]{git}
 \begin{itemize}
\item \href{https://git-scm.com/}{git}
\begin{minted}[bgcolor=mintedbg,frame=none,framesep=0pt,mathescape=true,fontsize=\footnotesize,tabsize=2,gobble=0]{shell}
git init
